...
module.exports = {
  ...
  DEFAULT_SPECIFIC_CONTROLLER_LIMIT:
    Number(process.env.DEFAULT_SPECIFIC_CONTROLLER_LIMIT) || 10,
  DEFAULT_NODES_LIMIT: Number(process.env.DEFAULT_NODES_LIMIT) || 5,
  DEFAULT_NODES_USAGE_LIMIT:
    Number(process.env.DEFAULT_NODES_USAGE_LIMIT) || 200,
  DEFAULT_CLUSTER_USAGE_LIMIT:
    Number(process.env.DEFAULT_CLUSTER_USAGE_LIMIT) || 200,
  liveControllerModelName:
  ...
  clusterRequestModelName:
    process.env.NODES_REQUEST_MODEL_NAME || "cluster-request",
  //----------FRONT-END----------------------------
