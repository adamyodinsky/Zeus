...
module.exports = {
  ...
  NODES_REQUEST_MODEL_NAME:
    process.env.NODES_REQUEST_MODEL_NAME || "node-request",
  CLUSTER_USAGE_MODEL_NAME:
    process.env.CLUSTER_USAGE_MODEL_NAME || "cluster-usage",
  CLUSTER_REQUEST_MODEL_NAME:
    process.env.CLUSTER_REQUEST_MODEL_NAME || "cluster-request",
};
